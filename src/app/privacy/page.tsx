...
export default function PrivacyPage() {
  return <main className="mx-auto max-w-3xl px-5 py-16 text-neutral-900">
    ...
    <div className="mt-10 space-y-8 leading-7 text-neutral-700">
      ...
      <section><h2 className="text-xl font-bold text-neutral-900">分析数据</h2><p className="mt-2">分析功能默认关闭。只有你在首次启动或“隐私与账户”中明确同意后，应用才会向 Amplitude、Mixpanel 和 ThinkingData 发送产品使用事件、应用版本和构建号。CoffeeBar iOS 首版不读取 IDFA，也不启用广告归因。</p></section>
